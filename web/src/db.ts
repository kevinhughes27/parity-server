...
// Assuming Point and Stats types are exported from your api.ts
// If api.ts is in web/src/, the path is correct.
...
export { db };
// Export StoredGame type for use in components
// export type { StoredGame }; // This line is redundant if StoredGame is already exported above.
