...
function NavItems(props: { closeNav: () => void }) {
  ...
  const podcastUrl =
    "https://soundcloud.com/user-640277634/sets/parity-podcast-season-5/s-1oSLUNq9qt4";
  const srcUrl = "https://github.com/kevinhughes27/parity-server";
  const volunteerUrl =
    "https://docs.google.com/spreadsheets/d/1djwi1LSuyiZMKS_aeFLEpsIfxQXqna2bD7ZxibR3OPA/edit#gid=0";

  const spreadsheets = [
    {
      name: "2019-2020",
      url: "https://docs.google.com/spreadsheets/d/12_SdWDIFQvCiNP3j4mlKZ19bXwmiLqXBJg_g_0K8UIw",
    },
    {
      name: "2018-2019",
      url: "https://docs.google.com/spreadsheets/d/1KTFwydcZrVoHqEGej1uyZk8rO58RDr_1tUMIh08yZN8",
    },
    {
      name: "2017-2018",
      url: "https://docs.google.com/spreadsheets/d/1F46H8ZRGP8Jzj1zSW0PT8HerBZ_BlHI5T48A2vp34r0",
    },
  ];
